...
export default function DashboardView({ students, onNavigate, onSelectStudent }: DashboardViewProps) {
  ...
  const filteredStudents = students.filter(student => {
    ...
    const matchesSearch = student.fullName.toLowerCase().includes(searchQuery.toLowerCase()) ||
      ...
      student.whatsapp.toLowerCase().includes(searchQuery.toLowerCase());
    ...
    <div className="flex flex-col gap-6 p-8 bg-[#FDFAF5] overflow-y-auto h-full select-none">
      ...
      <section className="grid grid-cols-4 gap-4">
        ...
        <div className="bg-white border border-[#D4C9B0] p-5 shadow-sm relative overflow-hidden group">
          ...
          <div className="mt-6 flex flex-wrap items-center justify-between text-xs font-semibold text-[#46464d] gap-1">
            <span>Daftar Mahasiswa Aktif</span>
            <span className="text-emerald-700 font-bold bg-emerald-50 px-1.5 py-0.5 rounded text-[10px] whitespace-normal">
      ...
      <div className="grid grid-cols-12 gap-6">
              ...
              <div className="flex bg-[#E8DEC8]/50 border border-[#D4C9B0]/60 p-0.5">
                {(['ALL', 'COMPLETE', 'INCOMPLETE'] as const).map(tab => (
                  <button
                    ...
                    className={`px-3 py-1 text-[10px] uppercase font-bold transition-all cursor-pointer ${filterType === tab
            ...
            <div className="px-5 py-3 bg-[#FDFAF5] border-b border-[#D4C9B0]/40 flex gap-2">
              <div className="relative flex-grow">
                <input
                  ...
                  placeholder="Cari berdasarkan nama, kode ID atau nomor whatsapp..."
                ...
                filteredStudents.map((student) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      {/* Avatar */}
                      <div className="w-10 h-10 rounded-full border border-[#D4C9B0] overflow-hidden bg-[#E8DEC8] flex items-center justify-center shrink-0 shadow-sm relative text-[#0c132c]">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] text-[#76767e] font-semibold mt-0.5">{student.userId} • {student.whatsapp}</p>
                    ...
                    <div className="flex items-center gap-3">
                      <span className={`px-2.5 py-1 text-[10px] font-extrabold uppercase tracking-wider ${student.status === 'COMPLETE'
        ...
        <div className="col-span-5 flex flex-col gap-5">
          ...
          {/* Quick action dispatch WhatsApp card */}
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h4 className="font-sans text-xs font-bold uppercase tracking-wider text-[#0c132c]">
                  Pengiriman Peringatan WhatsApp
                </h4>
                <p className="text-[11px] text-[#46464d] leading-normal mt-1 font-semibold">
                  Buat draf pesan dan kirimkan peringatan atribut yang tidak lengkap ke nomor WhatsApp mahasiswa secara otomatis.
                </p>
              </div>
            </div>
